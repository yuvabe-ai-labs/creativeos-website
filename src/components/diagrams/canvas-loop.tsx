...
export function CanvasLoop() {
  return (
    <svg viewBox="0 0 800 470" className="block h-auto w-full" aria-hidden="true">
      ...
      <text x="240" y="120" textAnchor="middle" style={{ fontWeight: "500", fontSize: "20px" }} fill="#6b7280">Script</text>
      <text x="560" y="120" textAnchor="middle" style={{ fontWeight: "500", fontSize: "20px" }} fill="#6b7280">Images</text>
      <text x="560" y="404" textAnchor="middle" style={{ fontWeight: "500", fontSize: "20px" }} fill="#6b7280">Video</text>
      <text x="240" y="404" textAnchor="middle" style={{ fontWeight: "500", fontSize: "20px" }} fill="#6b7280">Review</text>
    </svg>
  );
}
